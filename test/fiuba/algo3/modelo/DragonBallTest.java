...
public class DragonBallTest {
   ...
   @Test
    public void test05VerificoSiPersonajeSeMueveAcuerdoASuTransformacion()
    {
        ...
        tablero.moverPersonaje(majinBoo,5,5);
   ...
   /* @Test
    ...
    public void test23HacerTransformarAPiccoloMoviendoloEntreCoordenadas(){
    	Piccolo piccolo = new Piccolo();
    	Tablero tablero = new Tablero();
    	tablero.ubicarPersonaje(piccolo,1,1);
		tablero.moverPersonaje(piccolo,1,3);
		tablero.moverPersonaje(piccolo,1,5);
		tablero.moverPersonaje(piccolo,1,7);
		tablero.moverPersonaje(piccolo,1,9);

    	//Piccolo esta en estado fortalecido
		tablero.moverPersonaje(piccolo,1,12);

    	assertTrue(tablero.obtenerCasillero(1,12).ocupado());
    }
