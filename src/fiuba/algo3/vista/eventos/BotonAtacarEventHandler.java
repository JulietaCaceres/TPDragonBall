...
public class BotonAtacarEventHandler implements EventHandler<ActionEvent> {
    ...
    public BotonAtacarEventHandler(Juego juego, ContenedorTablero contenedorTablero) {
        this.juego = juego;
    ...
    public void handle(ActionEvent arg0) {
        ...
        {
            try {
                juego.obtenerTurno().atacarConPersonajeA(unPersonaje, unaCoordenada.obtenerCasillero().obtenerPersonaje());
